...
export const APIS = [AttendancesService, AuthService, ClassStudentsService, ClassesService, FacesService, HealthService, NotificationsService, ParentStudentsService, UsersService];
