...
from app.api.dependencies import get_db, get_current_user, get_face_detector, get_face_db
from app.models.user import User
from app.schemas.attendance import AttendanceOut, AttendanceCreate, AttendanceUpdate, AttendanceFaceCreate
...
async def create_face_attendance(
    ...
    return await attendance_service.create_face_attendance(db=db, face_detector=face_detector, threshold=threshold, k=k,
                                                           face_db=face_db, image=image
                                                           )
